...
error import {ERC20} from "@openzeppelin/contracts/token/ERC20/ERC20.sol"; 
TypeError: Trying to override non-virtual function. Did you forget to add "virtual"?
   --> @openzeppelin/contracts/token/ERC20/ERC20.sol:166:5:
    |
166 |     function _transfer(address from, address to, uint256 value) internal {
    |     ^ (Relevant source part starts here and spans across multiple lines).
Note: Overriding function is here:
   --> contracts/Coin100.sol:202:5:
    |
202 |     function _transfer(address sender, address recipient, uint256 amount) internal override whenNotPaused {
    |     ^ (Relevant source part starts here and spans across multiple lines).

    

also here is the ERC"""
// SPDX-License-Identifier: MIT
...
also when i comment out the contract code .... the error disappear .. so it's most likely somethign in the contract is causing this error 