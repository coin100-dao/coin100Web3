...
async function main() {
  ...
  console.log("Deploying COIN100 contract to Polygon Mainnet with:");
  ...
  console.log("COIN100 deployed to Polygon Mainnet at:", coin100.address);
  console.log(coin100);
...
main()
  .then(() => process.exit(0))
  .catch((error) => {
    console.error("Error deploying COIN100 to Polygon Mainnet:", error);
    process.exit(1);
  });
